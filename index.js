...
const numUnfundedGames=GAMES_JSON.filter(x=>x.pledged<x.goal).length;

// create a string that explains the number of unfunded games using the ternary operator
const displayStr=numUnfundedGames===0 ? "There is no unfunded games ." : `There ${numUnfundedGames===1 ? 'is' :'are'} ${numUnfundedGames} unfunded ${numUnfundedGames===1 ? 'game':'games'}.We need to help fund ${numUnfundedGames===1 ? 'this' :'these'} amazing ${numUnfundedGames===1?'game':'games'}.`;
